...
# Revision ID: a17440d8fa53
# Revises: 8ae96803c164
# Create Date: 2025-12-25 01:50:37.010974
...
# revision: str = 'a17440d8fa53'
# down_revision: Union[str, Sequence[str], None] = '8ae96803c164'
...
#     sa.Column('created_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), autoincrement=False, nullable=True),
#     sa.Column('updated_at', postgresql.TIMESTAMP(timezone=True), autoincrement=False, nullable=True),
#     sa.ForeignKeyConstraint(['book_id'], ['books.id'], name='announcements_book_id_fkey'),
